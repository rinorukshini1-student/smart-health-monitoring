...
// Singleton that aggregates runtime metrics for the System Health page:
//  - SignalR throughput observed by the dashboard (Kafka -> Spark -> dashboard pipeline)
//  - the latest StreamMetrics snapshot pushed by the streaming processor
//  - API response-time samples recorded by middleware
