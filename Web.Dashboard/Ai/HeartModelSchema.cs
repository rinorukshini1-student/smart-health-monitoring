...
// Inference input - column names/types must match the schema the model was trained on
// (AI.Training/HeartRecord, minus the Label which is not needed for scoring).
