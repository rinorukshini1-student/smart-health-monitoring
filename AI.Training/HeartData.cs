// Schema for the heart-attack dataset after pre-processing (Blood Pressure split into
// Systolic/Diastolic; non-clinical columns dropped). Mutable so columns can be permuted
// when computing model-agnostic permutation feature importance.
public sealed class HeartRecord
{
...
public sealed class HeartPrediction
{
