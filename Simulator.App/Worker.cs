...
public class Worker : BackgroundService
{
    ...
    // Generates realistic vitals. A small percentage of readings intentionally drift into
    // abnormal ranges so alerts and AI risk scores can be demonstrated live.
